...
# The name of the job:
#SBATCH --job-name="70b-instruct-zero-shot"
...
#SBATCH -o logs/70b-instruct-zero-shot-%N.%j.out # STDOUT
#SBATCH -e logs/70b-instruct-zero-shot-%N.%j.err # STDERR
...
python code_review_instruction_parallel.py \
    --ckpt_dir ./meta-llama/Llama-3.1-70B-Instruct \
    --tokenizer_path ./meta-llama/Llama-3.1-70B-Instruct \
    --conf_path ../config/zero-shot/llama-31-70B-instruct-crn.json \
    --temperature 0.0 --top_p 0.95 \
    --max_new_tokens 512 \
    --tp_size 4 \
    --debug False
